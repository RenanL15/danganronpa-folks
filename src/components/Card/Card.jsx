    ...
    <div className="flex flex-col items-center justify-center gap-3 mt-10">
      ...
      >
        <h1
          className={`${
            isDead && showSpoilers
              ? "z-10 font-['Rubik_Iso'] scale-[5] -rotate-12 top-36 left-32 absolute font-bold select-none text-red-700"
              : "hidden"
          }`}
        >
          DEAD
        ...
        <div className="bg-[rgb(20,20,20)] relative max-w-2xl p-5 rounded-b-[.8rem] cursor-pointer">
          <span className="text-xl m-auto text-center font-['PT_Sans'] inline-block">
            {chName}
          </span>
        </div>
      </div>
      <span
        className={`text-yellow-500 duration-[400ms] font-['PT_Sans'] ${
