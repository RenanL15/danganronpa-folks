  ...
  return (
    <div className="flex gap-6">
      <button
        ...
        className={`mt-5 p-3 font-['Roboto'] rounded-lg text-white font-bold transition ease-in-out ${
          spoilers
      ...
      <button
        onClick={sortByName}
        className={`mt-5 p-3 font-['Roboto'] rounded-lg text-white font-bold transition ease-in-out ${"bg-gray-600 hover:bg-gray-700"}`}>
        {"Sort by name"}
        {sort === "AZ" ? (
